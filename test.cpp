...
int main() {
  ...
  im.move_left(500);
  sleep(2);
  im.draw("imagen_desplazada_500_left.png");
  im.move_right(100);
  sleep(2);
  im.draw("imagen_desplazada_100_right.png");
  im.move_down(100);
  sleep(2);
  im.draw("imagen_desplazada_100_down.png");
  im.move_up(100);
  sleep(2);
  im.draw("imagen_desplazada_100_up.png");
